...
class ConfigTest {
    ...
    @Test void requiresStandardShortAndFifoLongQueueUrls() {
        ...
        for (var queue : new ServiceProperties.Queue[]{
            ...
            new ServiceProperties.Queue(true, "us-east-1", null, "https://sqs.test/short.fifo", "https://sqs.test/long.fifo"),
            new ServiceProperties.Queue(true, "us-east-1", null, "https://sqs.test/short", "https://sqs.test/long"),
